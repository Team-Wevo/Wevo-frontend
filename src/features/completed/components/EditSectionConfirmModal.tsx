...
const EditSectionConfirmModal = ({
  ...
  return (
    ...
    >
      <div
        className="flex w-full max-w-[440px] flex-col items-start gap-3.5 overflow-hidden rounded-lg bg-white px-7 pt-7 pb-6 shadow-[0px_16px_44px_-6px_rgba(23,26,41,0.22)]"
      ...
      >
        ...
        <p className="w-full text-sm leading-[23px] font-normal text-gray-700">
